...
def main():
    ...
    parser.add_argument('-d', type=int, default=3, help='[DOESNOT DO ANYTHING, depth is set to 2] This option specifies the depth of search for Minimax algorithm. The default value is 2.')
